...
cd denoiser 
rm -r colorization/*
python3 main_IRT.py --max_epoch 10 --input input/original --with_IRT 1 --IRT_initialization 1 --save_freq 5 --processed input/processed --model colorization  --output ./result/colorization
